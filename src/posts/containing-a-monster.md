...
## THE PERIMETER
[Retractable Safety Gate](https://amzn.to/3NQILD2){target=_blank}  
![Retractable safety gate](/img/containing-a-monster-fence.jpeg){.product sizes="150px" eleventy:widths="150,300,450"}
The first line of defense. This thing retracts like a window shade when you're not using it, which means no permanent eyesore blocking your hallway. Stretches up to 55 inches wide. Installs with adhesive, so no drilling required. The mesh won't give them footholds for climbing, though that won't stop them from trying. Install it at the stairs, in doorways, anywhere you need to establish that certain parts of the house are currently off-limits. It's not permanent. Nothing with toddlers is. But it holds long enough for you to finish whatever you were doing before they discovered a new way to endanger themselves.

## THE CABINETS
[Safety Strap Locks](https://amzn.to/4ky4axb){target=_blank}  
![Safety strap locks](/img/containing-a-monster-strap.jpeg){.product sizes="150px" eleventy:widths="150,300,450"}
...
## THE FURNITURE
[Anti-Tip Furniture Anchors](https://amzn.to/4kc8JwV){target=_blank}  
![Anti-tip furniture anchors](/img/containing-a-monster-anchor.jpeg){.product sizes="150px" eleventy:widths="150,300,450"}
...
## THE OUTLETS
[Self-Closing Outlet Covers](https://amzn.to/4qhxBVg){target=_blank}  
![Self-closing outlet covers](/img/containing-a-monster-outlet.jpeg){.product sizes="150px" eleventy:widths="150,300,450"}
